...
class DoceboConnectorDoceboUsers extends DoceboConnector
{
    ...
    var $directory = NULL;
    var $tree_view = NULL;
    /** @var PeopleListView $people_view */
    ...
    var $org_chart_group = [];
    var $user_org_chart = [];
    var $all_user_updated = [];

    var $arr_idst_inserted = [];

    var $org_chart_destination = 0;

    var $pwd_force_change_policy = 'do_nothing';

    var $inserted_user_org_chart = [];
    ...
    function connect()
    {
        ...
        if ($this->org_chart_destination == 0) {
            ...
            while (list($idstMember) = sql_fetch_row($re)) {
                ...
                if (!isset($this->user_org_chart[$idstMember])) $this->user_org_chart[$idstMember] = [];
