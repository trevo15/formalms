...
function insforum ()
{
    ...
    if (! empty($recipients)) {
        ...
        $msg_composer->setBodyLangText ('email' , '_NEW_FORUM_BODY' , [ '[url]' => Get::site_url() ,
            '[course]' => PUBLIC_FORUM_COURSE_NAME ,
            '[title]' => $_POST[ 'title' ] ,
            '[text]' => $_POST[ 'description' ] ]);

        $msg_composer->setBodyLangText ('sms' , '_NEW_FORUM_BODY_SMS' , [ '[url]' => Get::site_url() ,
            '[course]' => PUBLIC_FORUM_COURSE_NAME ,
            '[title]' => $_POST[ 'title' ] ,
            '[text]' => $_POST[ 'description' ] ]);
...
function thread ()
{
    ...
    $idForum = Get::gReq ('idForum' , DOTY_INT , 0);
...
function addthread ()
{
    ...
    $GLOBALS[ 'page' ]->add (
        ...
        . ((false === $moderate && (int)$maxThreads > 0) ? '<div class="forum__remaining-thread"><span>' . strtoupper ($remainingThreadsString) . '</span></div>' : '')
        , 'content');
    ...
    if ($canInsert) {
        ...
        $GLOBALS[ 'page' ]->add (
            ...
            . Form::getTextarea (Lang::t ('_TEXTOF') , 'textof' , 'textof')
            , 'content');
